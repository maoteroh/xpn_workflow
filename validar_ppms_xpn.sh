...
srun -n ${NP} --exclusive \
     ...
     $HOME/m_otero/xpn/data/workflow/load_files demo2.txt /tmp/expand/xpn/demo2.txt
     
srun -n ${NP} --exclusive \
     -w $HOME/m_otero/tmp/machinefile.${SLURM_JOBID} \
     --export=ALL \
     --cpus-per-task=2 --verbose \
     $HOME/m_otero/xpn/data/workflow/validar_ppms demo2.txt /tmp/expand/xpn/demo2.txt 
